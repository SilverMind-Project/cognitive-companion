"""Tests for the PWA announcement notification channel."""
...
from backend.channels.builtin.announcement import AnnouncementChannel
...
class TestAnnouncementChannelMetadata:
    def test_channel_name(self):
        meta = AnnouncementChannel.metadata()
        assert meta.channel_name == "announcement"
...
class TestStreamMode:
    ...
    async def test_streams_pcm_chunks(self):
        ...
        assert start_call[0][0]["type"] == "announcement"
