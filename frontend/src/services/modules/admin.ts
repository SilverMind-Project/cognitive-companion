...
export type InferenceTelemetryOut = components["schemas"]["InferenceTelemetryOut"];
...
/** LLM admission-controller telemetry: queue depth, wait percentiles, calls per caller/lane (DL-M09). */
export const getInferenceTelemetry = () =>
  unwrap(client.GET("/api/v1/admin/inference-telemetry", {}));
