...
const stubs = {
  ...
  "v-btn": {
    ...
    props: ["icon", "size", "variant", "color", "title", "aria-label", "prepend-icon", "disabled"],
  },
  "v-icon": { template: "<span><slot /></span>" },
  "v-list": { template: "<ul><slot /></ul>" },
  "v-list-item": {
    template: "<li @click=\"$emit('click')\"><slot /></li>",
    props: ["to", "prepend-icon", "title", "rounded"],
  },
  ...
  "v-text-field": {
    template: "<input />",
    props: ["modelValue", "label", "type", "hide-details", "append-inner-icon"],
  },
